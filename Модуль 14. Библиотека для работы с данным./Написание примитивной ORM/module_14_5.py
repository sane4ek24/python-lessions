...
from crud_functions_for_products import *
from crud_functions_for_users import *

api = "7644345056:AAFS6fKs71Npks0XmbtKwbo_zDnwNT7yBoI"
bot = Bot(token=api)
...
but_3 = InlineKeyboardButton(text='Регистрация')
kb.add(but)
kb.add(but_1)
kb.add(but_2)
kb.add(but_3)
